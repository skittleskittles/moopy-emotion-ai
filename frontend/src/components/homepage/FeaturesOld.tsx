...
const features: FeatureProps[] = [
  {
    ...
    //image: image4,
    image:
      "https://media.istockphoto.com/photos/assessment-and-analysis-by-professional-auditing-consultant-concept-picture-id1162629597?k=6&m=1162629597&s=170667a&w=0&h=rJGFR0BrEOpnsZzl3BqnLPcT0iK_fsj7M9v-6FWIiqI=",
  },
  {
    ...
    //image: image3,
    image:
      "https://www.cioinsight.com/wp-content/uploads/2022/08/Chatbots-in-Machine-Learning-2048x1365.jpeg",
  },
  {
    title: "Mood Tracker",
    description:
    ...
    //image: image,
    image:
      "https://i2.wp.com/101planners.com/wp-content/uploads/2020/03/Mood-Tracker-13-1187x1536.jpeg",
  },
  {
    title: "Real doctor",
    description:
    ...
    image:
      "https://th.bing.com/th/id/OIP.UEF6BYjO44FOGtSMSJnv_AHaHa?rs=1&pid=ImgDetMain",
  },
  {
    ...
    image:
      "https://www.singhead.com/uploads/20221031/2022103109164362072333_800%C3%97607.jpg",
  },
];
...
export const FeaturesOld = () => {
  return (
    <section id="featuresOld" className="container py-24 sm:py-32 space-y-8">
